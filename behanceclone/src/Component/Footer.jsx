    ...
    <DIV>
      <div className="blackFooter">
        ...
        <div className="footerCart">
          ...
          <div>
            <h5>FREE SHIPING & DELEVERY</h5>
            <p>
              You may compare with any other website and share the snapshot with
              us. We will offer you the same price.
            </p>
          </div>
        </div>
      </div>
      <div className="whiteFooter">
        <ul>
          ...
          <li>
            Studio Visit - B-1 & GF 1826, Next to Scottish Mall, P Block, Sector
            48, Gurugram, Haryana 122001
          </li>
          <li>Phone:(+91) 70424-40969</li>
          <li>Email:info@nicemaple.com</li>
          <li>
            <FaFacebookF /> <AiOutlineTwitter /> <AiOutlineInstagram />{" "}
            <FaLinkedinIn />{" "}
          </li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>
            Enter your email to receive daily news and get 10% off coupon for
            all items.
          </li>
          <li>
      ...
      <div className="downFooter">
        <p>
          © 2022 Nice Maple. All Rights Reserved By Nice Maple India Private
          Limited.
        </p>
        <img
          src="https://cdn.shopify.com/s/files/1/0617/5549/0489/files/paypal_cards224x59_2x_4375ba53-5ab6-4c1e-8b8b-7b1d895a7b57-min.png?v=1647292664"
          alt=""
        />
      </div>
